      ...
      <section id="home" className="container-wide relative flex min-h-screen items-center pt-24">
        <div className="grid w-full items-center gap-14 lg:grid-cols-[1.08fr_.92fr]">
          ...
          <div className="relative mx-auto w-full max-w-[480px]">
            <div className="absolute inset-8 rounded-full bg-blue-500/15 blur-[70px]" />
            <div className="relative aspect-square overflow-hidden rounded-[36px] border border-white/10 bg-gradient-to-br from-[#111a2c] to-[#070b13] p-5 shadow-glow">
              <div className="absolute inset-5 rounded-[28px] border border-blue-400/20" />
              <div className="absolute right-7 top-7 z-10 rounded-xl border border-violet-400/30 bg-[#080d18]/85 px-3 py-2 text-xs text-violet-200 backdrop-blur">
                <span className="mr-2 text-cyan-300">●</span>Turning ideas into impact
              </div>
              <div className="absolute bottom-6 left-6 z-10 rounded-xl border border-blue-400/20 bg-[#080d18]/85 px-3 py-2 font-mono text-xs text-slate-300">
                <span className="text-blue-300">developer</span>@<span className="text-violet-300">harshad</span>:~$
              </div>
              <Image src="/profile.jpg" alt="Harshad Shinde" fill className="object-cover object-top mix-blend-normal" priority sizes="(max-width: 768px) 90vw, 480px"/>
              <div className="absolute inset-x-0 bottom-0 h-1/3 bg-gradient-to-t from-[#070b13] via-[#070b13]/30 to-transparent"/>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="research" className="container-wide py-24">
        ...
        <div className="mt-3 grid gap-10 lg:grid-cols-[.75fr_1.25fr]">
          <div>
            ...
            <p className="mt-5 leading-7 text-slate-400">Published work covering healthcare AI, creativity and intelligent medication systems. Also holds a copyright registration from the Government of India.</p>
            <div className="mt-7 flex items-center gap-3 text-sm text-slate-300"><FileText size={17} className="text-violet-300"/> 3 peer-reviewed publications</div>
          </div>
